...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the LLM-backed query router node")
    ...
    parser.add_argument("--as-json", action="store_true", help="Print the route decision as JSON")
