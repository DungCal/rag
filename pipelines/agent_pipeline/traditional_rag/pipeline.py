...
from pipelines.agent_pipeline.shared.retriever_judge_node import (
    ...
    def _run_retrieval(self, state: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.enable_rerank and state["retriever_result"] is not None:
            if self._reranker is None:
                from pipelines.agent_pipeline.traditional_rag.rerank.rerank_node import RerankNode
...
def run_traditional_pipeline(args: argparse.Namespace) -> None:
    """Run the deterministic Pinecone-backed RAG pipeline."""
